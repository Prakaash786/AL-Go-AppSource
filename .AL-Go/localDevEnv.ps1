...
$GitHubHelperUrl = 'https://raw.githubusercontent.com/Prakaash786/AL-Go-Actions/Prakaash786/AL-Go/Github-Helper.psm1'
...
$ALGoHelperUrl = 'https://raw.githubusercontent.com/Prakaash786/AL-Go-Actions/Prakaash786/AL-Go/AL-Go-Helper.ps1'
